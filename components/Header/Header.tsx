    ...
    >
      <div className="max-w-c-1390 relative mx-auto items-center justify-between px-4 md:px-8 xl:flex 2xl:px-0">
        <div className="flex w-full items-center justify-between xl:w-1/4">
          <a href="/">
            <Image
              src="/images/logo/rekon-logo.png"
              alt="logo"
              width={190}
              height={100}
              className="hidden w-full mix-blend-multiply dark:block dark:mix-blend-normal"
            />
            <Image
              src="/images/logo/rekon-logo.png"
              alt="logo"
              width={119.03}
              height={30}
              className="w-full mix-blend-multiply dark:hidden dark:mix-blend-normal"
            />
          </a>
