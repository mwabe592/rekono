            ...
            <form action={action}>
              <div className="mb-7.5 flex flex-col gap-7.5 lg:mb-12.5 lg:flex-row lg:justify-between lg:gap-14">
                <input
                  ...
                  name="email"
                  required
                  className="border-stroke focus:border-waterloo dark:border-strokedark dark:focus:border-manatee w-full border-b bg-white pb-3.5 focus:placeholder:text-black focus-visible:outline-none lg:w-1/2 dark:bg-black dark:focus:placeholder:text-white"
                />
